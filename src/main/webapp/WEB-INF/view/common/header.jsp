...
<script type="text/javascript">
	...
	function searchCampingPlace(){
		location.href = "/GreatCamping/campingPlace/campingPlaceList?keyword=" + $(".searchBox").val();
	}
</script>
</head>
...
<div id="header-wrapper">
	<div id="header-layer1">
		...
		<a href="javascript:searchCampingPlace();"><img alt="search" src="<c:url value='/img/magnifier-icon.png'/>" style="width:20px;height:20px;float:left;margin-left:5px;"></a>
