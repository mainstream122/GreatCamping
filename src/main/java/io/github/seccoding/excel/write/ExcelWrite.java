...
public class ExcelWrite {
	...
	public static void write(WriteOption writeOption, HttpServletResponse response) {
		Workbook wb = FileType.getWorkbook(writeOption.getFileName());
		sheet = wb.createSheet(writeOption.getSheetName());
		...
		response.setHeader("Content-Disposition", "Attachment; Filename="+writeOption.getFileName());
