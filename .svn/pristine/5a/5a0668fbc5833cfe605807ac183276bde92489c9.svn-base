...
<div class="main-wrapper">
	<div id="main-board">
		<div class="board-div left">
			<h2>공지사항</h2>
			<ul>
				<c:forEach items="${noticeList}" var="nitem" begin="0" end="3">
					<li><a href="/GreatCamping/notice/view/${nitem.noticeId}">
					<span class="board-title">${nitem.noticeSubject}</span>
					<span class="board-date">${nitem.noticeDate} </span></a></li>
				</c:forEach>
				<!-- <li><a href="#">
