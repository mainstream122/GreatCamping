...
import io.github.seccoding.web.pager.explorer.func.CustomFunction;
...
public abstract class PageExplorer {
	...
	protected String nowPageClassName;
	...
	public PageExplorer highlightClassName(String className) {
		this.nowPageClassName = className;
		return this;
	}
