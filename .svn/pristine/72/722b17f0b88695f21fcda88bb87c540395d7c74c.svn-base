...
public class Decorator {
	...
	public String makeHighlightNowPageNumberClassName(String className) {
		return className;
	}
	...
	public String makePageNumbers(int pageIndex, String pageNumber, String className) {
		return "<a class='"+className+"' href=\"javascript:movePage('" + pageIndex + "')\">" + pageNumber + "</a>";
	}
